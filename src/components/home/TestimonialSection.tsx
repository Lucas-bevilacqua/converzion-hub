      ...
      <div className="container relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <Card 
              ...
              className="border border-[#333333]/10 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group"
            >
              <CardContent className="pt-6">
                <Quote className="h-8 w-8 text-[#00C896] mb-4 opacity-50 group-hover:opacity-100 transition-opacity" />
                ...
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 rounded-full overflow-hidden ring-2 ring-[#0056D2]/20 group-hover:ring-[#0056D2] transition-all">
                    <img
                  ...
                  <div>
                    <p className="font-semibold text-[#333333] group-hover:text-[#0056D2] transition-colors">{testimonial.name}</p>
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="p-8 bg-white rounded-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border border-[#333333]/10">
