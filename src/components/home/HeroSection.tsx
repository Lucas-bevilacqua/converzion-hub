      ...
      <div className="container relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Transforme seu atendimento com inteligência artificial avançada. 
            Respostas instantâneas, 24 horas por dia, aumentando suas conversões.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center gap-3 justify-center">
              ...
              <span className="text-gray-300">Inteligência Artificial Avançada</span>
            </div>
            <div className="flex items-center gap-3 justify-center">
              <div className="p-2 rounded-full bg-[#9b87f5]/20 backdrop-blur-sm">
                <Shield className="h-5 w-5 text-[#9b87f5]" />
              </div>
              <span className="text-gray-300">Segurança Garantida</span>
            </div>
            <div className="flex items-center gap-3 justify-center">
              <div className="p-2 rounded-full bg-[#9b87f5]/20 backdrop-blur-sm">
